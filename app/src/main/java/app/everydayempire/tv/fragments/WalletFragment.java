...
import app.everydayempire.tv.activities.PaymentActivity;
import app.everydayempire.tv.common.DiffUtilCallback;
import app.everydayempire.tv.common.LoadingState;
import app.everydayempire.tv.data.CreditDataSource;
...
public class WalletFragment extends Fragment implements PurchasesUpdatedListener {
    ...
    private void submitIabPurchase(Purchase purchase) {
        ...
        REST rest = MainApplication.getContainer().get(REST.class);
        rest.walletRechargeIab(purchase.getSku(), purchase.getPurchaseToken())
                .enqueue(new Callback<Wrappers.Single<Balance>>() {
