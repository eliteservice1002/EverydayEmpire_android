...
import app.everydayempire.tv.ads.natives.AdMobNativeAdProvider;
import app.everydayempire.tv.ads.natives.FacebookNativeAdProvider;
import app.everydayempire.tv.ads.natives.MoPubNativeAdProvider;
import app.everydayempire.tv.ads.natives.NativeAdProvider;
import app.everydayempire.tv.ads.natives.NativeAdProviderFactory;
...
public class NativeAdFragment extends Fragment implements VisibilityAware {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (ad != null) {
            ...
            if (mAd instanceof FacebookNativeAdProvider) {
                ((FacebookNativeAdProvider) mAd).setLayout(R.layout.view_native_facebook_full);
            }
            if (mAd instanceof MoPubNativeAdProvider) {
                ((MoPubNativeAdProvider) mAd).setLayout(R.layout.view_native_mopub_full);
            }
        }
    }
