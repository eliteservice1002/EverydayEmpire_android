...
import app.everydayempire.tv.ads.InterstitialAdProvider;
...
import app.everydayempire.tv.data.ArticleDataSource;
import app.everydayempire.tv.data.ArticleSectionDataSource;
...
public class NewsFragment extends Fragment {
    ...
    private void showUrlBrowser(Article article) {
        ...
        if (ad) {
            Runnable show = mAd2.create(requireActivity());
            if (show != null) {
                show.run();
            }
        } else {
