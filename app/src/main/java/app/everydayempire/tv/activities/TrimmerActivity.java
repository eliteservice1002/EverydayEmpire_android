...
import app.everydayempire.tv.trimmer.TrimTimeBar;
...
import app.everydayempire.tv.workers.VideoTrimmerWorker4;
...
public class TrimmerActivity extends AppCompatActivity implements AnalyticsListener, TrimTimeBar.Listener {
    ...
    public static final String EXTRA_SONG_ID = "song";
    ...
    private void proceedToAdjustment(File file) {
        ...
        intent.putExtra(AdjustAudioActivity.EXTRA_SONG_ID, mSong);
    ...
    private void proceedToFilter(File file) {
        ...
        intent.putExtra(FilterActivity.EXTRA_SONG_ID, mSong);
        startActivity(intent);
        finish();
    }
