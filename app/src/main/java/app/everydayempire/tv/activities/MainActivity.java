...
import app.everydayempire.tv.MainNavigationDirections;
...
import app.everydayempire.tv.common.SharingTarget;
import app.everydayempire.tv.data.ItemDataSource;
import app.everydayempire.tv.data.api.REST;
import app.everydayempire.tv.data.dbs.ClientDatabase;
...
import app.everydayempire.tv.fragments.PromotionsDialogFragment;
import app.everydayempire.tv.utils.AdsUtil;
import app.everydayempire.tv.utils.PackageUtil;
import app.everydayempire.tv.utils.TempUtil;
import app.everydayempire.tv.utils.VideoUtil;
import app.everydayempire.tv.workers.DeviceTokenWorker;
import retrofit2.Call;
import retrofit2.Callback;
import retrofit2.Response;

import static app.everydayempire.tv.fragments.EditBarpadFragment.ARG_BARPAD;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        Log.e(TAG, "Received request: " + requestCode + ", result: " + resultCode + ".");
        if (requestCode == SharedConstants.REQUEST_CODE_LOGIN_GOOGLE && resultCode == RESULT_OK && data != null) {
            ...
            intent.putExtra(RecorderActivity.EXTRA_AUDIO, audio);
    ...
    public void showBarpadSheet() {
        View sheet = findViewById(R.id.record_barpad_sheet);
        ...
        sheet.findViewById(R.id.record_screen).setOnClickListener(v -> {
        ...
        sheet.findViewById(R.id.barpad_show).setOnClickListener(v -> {
            bsb.setState(BottomSheetBehavior.STATE_COLLAPSED);
            showBarpadPage();
        });
        bsb.setState(BottomSheetBehavior.STATE_EXPANDED);
    ...
    public void showBarpadPage() {
        NavDirections direction = MainNavigationDirections.actionShowBarpad();
        findNavController().navigate(direction);
    }

    public void showEditBarpadPage(int barpad) {
        NavDirections direction = MainNavigationDirections.actionShowEditBarpad(barpad);
        findNavController().navigate(direction);
    }
