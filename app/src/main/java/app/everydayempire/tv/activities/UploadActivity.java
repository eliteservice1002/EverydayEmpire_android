...
import app.everydayempire.tv.workers.FixFastStartWorker2;
import app.everydayempire.tv.workers.GeneratePreviewWorker;
import app.everydayempire.tv.workers.UploadClipWorker;
...
public class UploadActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        TextInputLayout location = findViewById(R.id.location1);
