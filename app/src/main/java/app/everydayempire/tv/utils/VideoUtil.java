package app.everydayempire.tv.utils;
...
import app.everydayempire.tv.workers.FileDownloadWorker;
import app.everydayempire.tv.workers.FixFastStartWorker3;
import app.everydayempire.tv.workers.WatermarkWorker;
...
final public class VideoUtil {
    ...
    public static int getBitrate(int width, int height) {
        return (int) (.07 * 30 * width * height * SharedConstants.BITRATE_MULTIPLIER);
    }
