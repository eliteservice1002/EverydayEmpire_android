...
final public class SharedConstants {
    ...
    public static final float BITRATE_MULTIPLIER = 1.5f;

    public static final int CACHE_COUNT = 999;
    public static final long CACHE_SIZE = 256 * 1024 * 1024;
    ...
    public static final int MAX_PHOTO_RESOLUTION = 512;

    /**
     * Use only multiples of 16 e.g., 720, 960, 1280, 1440, 1600, 1920 etc.
     */
    public static final int MAX_VIDEO_RESOLUTION = 960;
    ...
    public static final int REQUEST_CODE_BARPAD_LIST = 60600 + 15;
    public static final int REQUEST_CODE_PICK_BARPAD_SONG = 60600 + 16;
