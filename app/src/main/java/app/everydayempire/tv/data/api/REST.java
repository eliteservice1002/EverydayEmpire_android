package app.everydayempire.tv.data.api;
...
import app.everydayempire.tv.data.models.Article;
import app.everydayempire.tv.data.models.ArticleSection;
import app.everydayempire.tv.data.models.Balance;
...
import app.everydayempire.tv.data.models.ClipSection;
import app.everydayempire.tv.data.models.Comment;
import app.everydayempire.tv.data.models.Credit;
import app.everydayempire.tv.data.models.Exists;
import app.everydayempire.tv.data.models.Gift;
import app.everydayempire.tv.data.models.Hashtag;
import app.everydayempire.tv.data.models.Item;
import app.everydayempire.tv.data.models.Message;
import app.everydayempire.tv.data.models.Notification;
import app.everydayempire.tv.data.models.Promotion;
import app.everydayempire.tv.data.models.Redirect;
import app.everydayempire.tv.data.models.Redemption;
...
import app.everydayempire.tv.data.models.StickerSection;
import app.everydayempire.tv.data.models.Thread;
import app.everydayempire.tv.data.models.Token;
import app.everydayempire.tv.data.models.UnreadNotifications;
...
public interface REST {
    ...
    @GET("barpads")
    Call<Wrappers.Paginated<Barpad>> barpadsIndex(@Query("page") int page);

    @GET("barpads/getbarpads/{user}")
    Call<Wrappers.Paginated<Barpad>> barpadsIndex(@Path("user") int user, @Query("page") int page);

    @GET("barpads/{id}")
    Call<Wrappers.Single<Barpad>> barpadsShow(@Path("id") int barpad);

    @Headers("Accept: application/json")
    @FormUrlEncoded
    @POST("barpads")
    Call<Wrappers.Single<Barpad>> barpadsCreate(
            @Field("song") @Nullable String song,
            @Field("user") @Nullable int user,
    ...
    @FormUrlEncoded
    @PUT("barpads/{id}")
    Call<Wrappers.Single<Barpad>> barpadsUpdate(
            @Path("id") int barpad,
            @Field("song") @Nullable String song,
            @Field("user") @Nullable int user,
            @Field("description") @Nullable String description,
    ...
    @FormUrlEncoded
    @DELETE("barpads/{id}")
    Call<ResponseBody> barpadsDelete(
            @Path("id") int barpad
    );
}
