package app.everydayempire.tv.data.entities;
...
public class Draft implements Parcelable {
    ...
    protected Draft(Parcel in) {
        ...
        allowDuet = in.readByte() != 0;
        ctaLabel = in.readString();
        ctaLink = in.readString();
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeByte((byte) (allowDuet ? 1 : 0));
        dest.writeString(ctaLabel);
        dest.writeString(ctaLink);
